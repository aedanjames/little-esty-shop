...
discount1 = @merchant1.discounts.create!(name: 'five', threshold: 5, percentage: 20)
discount2 = @merchant1.discounts.create!(name: 'ten', threshold: 10, percentage: 30)
discount3 = @merchant1.discounts.create!(name: 'three', threshold: 3, percentage: 10)
discount4 = @merchant2.discounts.create!(name: 'christmas', threshold: 3, percentage: 15)
discount5 = @merchant2.discounts.create!(name: 'black friday', threshold: 5, percentage: 25)
discount6 = @merchant2.discounts.create!(name: 'cyber monday', threshold: 10, percentage: 10)
discount7 = @merchant2.discounts.create!(name: 'valentines day', threshold: 6, percentage: 15)
